...
* Relational Databases are a type of database that stores and provides access to data points that are related to one another.
* SQL (meaning Structured Query Language) is the language used to manage and retrieve data stored in a relational database.

- [x] Why do tables need a `primary key`?
* Tables need a primary key in order to uniquely identify each of the records inside.

- [x] What is the name given to a table column that references the primary key on another table.
* It's called a foreign key.

- [x] What do we need in order to have a _many to many_ relationship between two tables.
* We will need a third table in which each record has foreign keys matching the primary keys of the first two tables.
